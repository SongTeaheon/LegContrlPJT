...
public class BluetoothService {
    ...
    private static final UUID MY_UUID =
            UUID.fromString("00001101-0000-1000-8000-00805f9b34fb"); //RFCOMM 프로토
    ...
    // Constructors
     ...
     public boolean getDeviceState(){
         Log.d(TAG, "Check the Bluethooth support");
    ...
    private synchronized void setState(int state) {
        ...
        if(state != STATE_CONNECTED){
            ...
            msg.what = MainActivity.MODE_NOT_CONNECTED;
    ...
    public synchronized void connect(BluetoothDevice device) {
        ...
        if (mState == STATE_CONNECTING) {
            if (mConnectThread == null) {
                Log.e(TAG, "mConnectThread is null");
        ...
        // Cancel any thread currently running a connection
        if (mConnectedThread == null) {
            Log.e(TAG, "mConnectedThread is null. good");
        } else {
            Log.e(TAG, "mConnectedThread is not null so cancel");
            mConnectedThread.cancel();
            mConnectedThread = null;
        }
